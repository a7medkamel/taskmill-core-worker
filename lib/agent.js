...
Agent.prototype.reqs = {};

Agent.prototype.stdout = function(id, buf){
  this.io.to(id).emit('stdout', buf);
};

Agent.prototype.stderr = function(id, buf){
  this.io.to(id).emit('stderr', buf);
};

Agent.prototype.listen = function(options, cb) {
